...
happyExpList = Happy_Data_Array.listArray (0,116) ([4032,6672,1008,1668,2,0,49024,16391,0,0,0,0,0,0,0,2048,0,1024,0,252,417,16447,104,0,2,0,512,0,16128,26688,4032,6672,63488,379,0,0,16447,104,16,0,0,64512,41216,16129,26688,4032,6672,1008,1668,252,417,16447,49256,4111,61466,33795,64518,41216,16129,26688,4032,6672,49152,3,61440,0,15360,6,36608,1,0,0,0,0,0,0,0,49152,123,61440,30,48128,49159,4111,26,0,0,0,32768,6079,57344,495,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exps","Exp","nl","int","true","false","string","var","varName","'='","'=='","and","or","'<'","'>'","'<='","'>='","not","'+'","'-'","'*'","'/'","'('","')'","print","readLine","%eof"]
        bit_start = st * 30
        bit_end = (st + 1) * 30
...
action_3 (24) = happyShift action_31
action_3 (25) = happyShift action_32
action_3 _ = happyReduce_3

action_4 (7) = happyShift action_21
...
action_9 (13) = happyShift action_19
...
action_20 (13) = happyShift action_44
...
action_35 (24) = happyShift action_31
...
action_36 (24) = happyShift action_31
action_36 (25) = happyShift action_32
...
action_42 (19) = happyShift action_27
action_42 (20) = happyShift action_28
action_42 (22) = happyShift action_29
action_42 (23) = happyShift action_30
action_42 (24) = happyShift action_31
action_42 (25) = happyShift action_32
...
action_43 (23) = happyShift action_30
action_43 (24) = happyShift action_31
action_43 (25) = happyShift action_32
...
action_50 (18) = happyShift action_26
action_50 (19) = happyShift action_27
action_50 (20) = happyShift action_28
...
happyReduction_20 (HappyTerminal (TokenBool _ happy_var_1))
	 =  HappyAbsSyn5
...
happyReduction_21 (HappyTerminal (TokenBool _ happy_var_1))
	 =  HappyAbsSyn5
...
happyReduction_22 (HappyTerminal (TokenString _ happy_var_1))
	 =  HappyAbsSyn5
		 (Type (Bool happy_var_1)
	)
...
happyReduction_24 (HappyTerminal (TokenName _ happy_var_1))
	 =  HappyAbsSyn5
		 (Lookup happy_var_1
	)
...
happyReduction_25 (HappyTerminal (TokenName _ happy_var_2))
	_
	 =  HappyAbsSyn5
		 (Declare happy_var_2
	)
